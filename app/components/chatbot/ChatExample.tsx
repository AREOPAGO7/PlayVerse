...
export default function ChatPopup() {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div 
          className="fixed bottom-6 right-6 w-[480px] h-[640px] bg-white rounded-lg shadow-2xl z-40 overflow-hidden bg-zinc-900"
        >
          <div className="flex flex-col h-[640px] bg-zinc-900">
            {/* Header */}
            <div className="bg-white p-3 flex items-center justify-between border-b bg-zinc-900">
