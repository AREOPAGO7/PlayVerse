  ...
  return (
    <div className="bg-zinc-900 rounded-lg p-6 shadow-lg border border-zinc-800">
      <div className="flex justify-between items-center mb-3">
        ...
        <span className="text-sm px-3 py-1 bg-zinc-800 rounded-full text-zinc-400 border border-zinc-700">
          {xp || 0} / {(level || 1) * 1000} XP
        </span>
      </div>
      <div className="w-full bg-zinc-800 rounded-full h-2.5 mb-4 border border-zinc-700">
      ...
      {editing && (
        <div className="mt-4 grid grid-cols-2 gap-4 bg-zinc-800 p-4 rounded-lg border border-zinc-700">
          <div>
            <label className="text-xs text-zinc-400 block mb-1">Experience Points</label>
            <input
              type="number"
              value={editedXp || 0}
