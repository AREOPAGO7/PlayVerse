...
const SignUpForm = ({  }: SignInProps) => {
  ...
  return (
    <div className="">
      <h2 className={`text-2xl font-semibold text-center mb-6 text-black/80 ${poppins.className}`}>PlayVerse</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          className={`w-full text-sm bg-black text-white rounded-lg py-2 font-medium hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:bg-gray-400 ${poppins.className}`}
          type="submit"
          disabled={loading}
        >
